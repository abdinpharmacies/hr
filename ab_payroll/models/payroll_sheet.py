...
class AbHrPayrollSheet(models.Model):
    ...
    attachment_id = fields.Many2one("ir.attachment", string="Payroll Attachment", ondelete="restrict", copy=False)
    ...
    telegram_message_id = fields.Char(string="Telegram Message ID", readonly=True, copy=False)
