...
class AbPrinter(models.Model):
    ...
    notes = fields.Text()
    extra_feed_lines = fields.Integer(default=0)
    ...
    def _render_html_to_pdf(self, html_content, workdir):
        ...
        html_file.write_text(self._prepare_print_html(html_content), encoding="utf-8")
        result = subprocess.run(
            [
                wkhtmltopdf_bin,
                "--encoding",
    ...
    def _render_html_to_escpos_bin(self, html_content, workdir):
        ...
        try:
            ...
            if self.extra_feed_lines:
                printer.text("\n" * self.extra_feed_lines)
