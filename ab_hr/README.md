# ab_hr Payroll Sheet Telegram Distribution
...
Install and configure these modules before using payroll sheet distribution:

- `ab_hr`
- `ab_request_telegram`
- `ab_hr_telegram_employee_link`

`ab_hr_telegram_employee_link` is required so employees can link their Telegram
chat information to their HR employee record before payroll sheets are sent.
